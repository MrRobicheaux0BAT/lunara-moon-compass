...
function paintPhaseDisc(phase, fraction) {
  ...
  bodyDisc.style.setProperty('--phase-x', `${side * (15 + shade * 70)}%`)
  bodyDisc.style.setProperty('--phase-shade', String(0.2 + shade * 0.75))
  bodyDisc.style.setProperty('--lit', String(lit))
}
